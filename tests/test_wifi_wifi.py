...
class TestWiFiController(unittest.TestCase):
    ...
    def test_connect_with_backoff_active(self, mock_timer_class,
                                         mock_wlan_class):
        mock_wlan = Mock()
        mock_wlan_class.return_value = mock_wlan
    ...
    @patch('app.wifi.wifi.network.WLAN')
    @patch('app.wifi.wifi.Timer')
    def test_connect_creates_backoff_timer(self, mock_timer_class,
                                           mock_wlan_class):
        mock_wlan = Mock()
        mock_wlan_class.return_value = mock_wlan
    ...
    @patch('app.wifi.wifi.network.WLAN')
    @patch('app.wifi.wifi.Timer')
    def test_connect_deinits_existing_timer(self, mock_timer_class,
                                            mock_wlan_class):
        mock_wlan = Mock()
        mock_wlan_class.return_value = mock_wlan
